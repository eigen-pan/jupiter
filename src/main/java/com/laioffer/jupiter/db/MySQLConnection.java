...
public class MySQLConnection {
    ...
    // insert a favorite item to the database
    ...
    throws MySQLException{
        ...
        // need to make sure that the item is already in items table first
        ...
        String sql = "INSERT IGNORE INTO favorite_records"+
    ...
    // remove a favorite item form database
    ...
    public void saveItem(Item item)
            throws MySQLException {
        if (conn == null) {
            String errorMessage = "failed to connect to DB";
            System.err.println(errorMessage);
            throw new MySQLException(errorMessage);
        }
