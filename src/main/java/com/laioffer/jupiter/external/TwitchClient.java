...
public class TwitchClient {
    private static final String TOKEN = "Bearer 36umyh7wa0ignykonxixgn6ntpkaxi";
    private static final String CLIENT_ID = "3f46cnbsukku8lauurl5h2qaw7357k";
    ...
    private String buildGameURL(String url, String gameName, int limit) {
        if (gameName.equals("")){
            ...
            try {
                ...
                gameName = URLEncoder.encode(gameName,"UTF-8");  // 把空格变成%20
